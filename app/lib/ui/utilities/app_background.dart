...
class AppBackgroundPattern extends StatelessWidget {
  ...
  final bool logo;
  AppBackgroundPattern({Key key, this.logo = false}) : super(key: key);
      ...
      child: Stack(
        children: <Widget>[
          ...
          Positioned(
            top: 60,
            left: 44,
            child: _circlePattern(context, 100)
          ),
          Positioned(
            top: 180,
            left: 16,
            child: _circlePattern(context, 60)
          ),
          Positioned(
            top: 240,
            left: 80,
            child: _circlePattern(context, 80)
          ),
          Positioned(
            bottom: -(half / 2),
            left: -(half / 2),
          ...
          Positioned(
            bottom: 200,
            right: 12,
            child: _circlePattern(context, 240)
          ),
        ],
      )
    );
