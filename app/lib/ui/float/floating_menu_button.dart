...
class FoldFloatingButton extends StatelessWidget {
  ...
  // ** メニュー表示時に表示されるFAB
  final void Function() floatOpenCallback;
    ...
    return FadeTransition(
      ...
      child: Transform(
          transform: Matrix4.translationValues(
              0.0, 20 * (1.0 - fadeAnimation.value), 0.0),
  ...
  Widget _floatingButtonWidget(double bottomPadding) {
    return Positioned(
        ...
        child: Column(
          children: <Widget>[
            isExpanded
                ? _fadeAnimationWidget(child: Column(children: expandedWidget))
                : Container(),
      ...
      children: <Widget>[
        ...
        Transform.rotate(
          ...
          child: FloatingActionButton(
            ...
            backgroundColor:
                controller.value > 0.5 ? AppTheme.primary : Colors.white,
  ...
  Widget build(BuildContext context) {
    final double bottomPadding =
        math.max(MediaQuery.of(context).padding.bottom - 9.0, 0.0);
