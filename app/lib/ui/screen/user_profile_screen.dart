...
class _UserProfileScreen extends State<UserProfileScreen> {
                            ...
                            widget.editable
                                ? Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      borderRadius:
                                          BorderRadius.circular(circleSize),
                                      splashColor: Colors.white24,
                                      child: Container(
                                        width: circleSize,
                                        height: circleSize,
  ...
  Future getImage(bool isBack) async {
    ...
    setState(() {
      if (isBack) {
        _selectedBackImage = File(image.path);
      } else {
...
class UserDetailClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    double line =
        math.sqrt(math.pow(radius, 2) - math.pow(radius - circleTop, 2));
